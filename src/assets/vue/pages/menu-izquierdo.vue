<template>
  <f7-page>
    <f7-block-title>Menu de Navegacion</f7-block-title>
    <f7-block>
      <p>Aqui tendras acceso a los distintos tipos de funciones que nos permiten Agregar, Modificar, y Eliminar estados del sistema.</p>
    </f7-block>
    <f7-block-title>Productos</f7-block-title>
    <f7-list>
      <f7-list-item link="/agregar-producto/" title="Agregar" panel-close></f7-list-item>
      <f7-list-item link="/form/" title="Mostrar todos" panel-close></f7-list-item>
    </f7-list>
    <f7-block>
